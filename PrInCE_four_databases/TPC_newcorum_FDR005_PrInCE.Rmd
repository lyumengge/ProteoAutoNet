---
title: "TPC_newcorum_PrInCE_FDR005"
author: "MenggeLYU"
date: "2024-09-20"
...
save.image("TPC_newcorum_FDR005_PrInCE.RData")
rio::export(interactions, "TPC_newcorum_FDR005_interactions.tsv")
```


```{r Interactions plot}
pdf("TPC_newcorum_PrInCE_FDR005_interactions_truepositive_withcutoff05.pdf")
...
```{r Output}
rio::export(interactions_alltrue, "TPC_newcorum_FDR005_interactions_alltrue.tsv")
rio::export(interactions_cutoff, "TPC_newcorum_FDR005_interactions_alltrue_over05.tsv")
save.image("TPC_newcorum_FDR005_PrInCE.RData")
```