---
title: "FTC238_complex_portal_PrInCE_FDR005"
author: "MenggeLYU"
date: "2024-09-20"
...
setwd("/PrInCE/FDR005/complex_portal/FTC238")
library(ggplot2)
library(PrInCE)
library(CCprofiler)
library(dplyr)
...
gold_standard <- rio::import("Complex_portal_complex_binary.csv")
...
save.image("FTC238_complex_portal_FDR005_PrInCE.RData")
rio::export(interactions, "FTC238_complex_portal_FDR005_interactions.tsv")
```


```{r Interactions plot}
pdf("FTC238_complex_portal_PrInCE_FDR005_interactions_truepositive_withcutoff05.pdf")
...
```{r Output}
rio::export(interactions_alltrue, "FTC238_complex_portal_FDR005_interactions_alltrue.tsv")
rio::export(interactions_cutoff, "FTC238_complex_portal_FDR005_interactions_alltrue_over05.tsv")
save.image("FTC238_complex_portal_FDR005_PrInCE.RData")
```