---
title: "Nthy_newcorum_PrInCE_FDR005"
author: "MenggeLYU"
date: "2024-09-20"
...
gold_standard <- rio::import("corum_complex_binary.csv")
...
save.image("Nthy_newcorum_FDR005_PrInCE.RData")
rio::export(interactions, "Nthy_newcorum_FDR005_interactions.tsv")
```


```{r Interactions plot}
pdf("Nthy_newcorum_PrInCE_FDR005_interactions_truepositive_withcutoff05.pdf")
...
```{r Output}
rio::export(interactions_alltrue, "Nthy_newcorum_FDR005_interactions_alltrue.tsv")
rio::export(interactions_cutoff, "Nthy_newcorum_FDR005_interactions_alltrue_over05.tsv")
save.image("Nthy_newcorum_FDR005_PrInCE.RData")
```