...
save.image("TPC_humap_FDR005_PrInCE.RData")
rio::export(interactions, "TPC_humap_FDR005_interactions.tsv")
```


```{r Interactions plot}
pdf("TPC_humap_PrInCE_FDR005_interactions_truepositive_withcutoff05.pdf")
...
```{r Output}
rio::export(interactions_alltrue, "TPC_humap_FDR005_interactions_alltrue.tsv")
rio::export(interactions_cutoff, "TPC_humap_FDR005_interactions_alltrue_over05.tsv")
save.image("TPC_humap_FDR005_PrInCE.RData")
```