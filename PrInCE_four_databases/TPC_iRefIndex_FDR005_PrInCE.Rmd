...
setwd("/PrInCE/FDR005/newcorum/TPC")
library(ggplot2)
library(PrInCE)
library(CCprofiler)
library(dplyr)
...
gold_standard <- rio::import("iRefIndex_TPC1_filteration200_deduplicate.tsv")
...
save.image("TPC_200iRefIndex_FDR005_PrInCE.RData")
rio::export(interactions, "TPC_200iRefIndex_FDR005_PrInCE.tsv")
```


```{r Interactions plot}
pdf("TPC_200iRefIndex_PrInCE_FDR005_interactions_truepositive_withcutoff05.pdf")
...
```{r Output}
rio::export(interactions_alltrue, "TPC_200iRefIndex_FDR005_interactions_alltrue.tsv")
rio::export(interactions_cutoff, "TPC_200iRefIndex_FDR005_interactions_alltrue_over05.tsv")
save.image("TPC_200iRefIndex_FDR005_PrInCE.RData")
```