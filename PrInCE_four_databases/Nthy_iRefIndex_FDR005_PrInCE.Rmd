...
setwd("/PrInCE/FDR005/newcorum/Nthy")
library(ggplot2)
library(PrInCE)
library(CCprofiler)
library(dplyr)
...
gold_standard <- rio::import("iRefIndex_Nthy1_filteration200_deduplicate.tsv")
...
save.image("Nthy_200iRefIndex_FDR005_PrInCE.RData")
rio::export(interactions, "Nthy_200iRefIndex_FDR005_PrInCE.tsv")
```


```{r Interactions plot}
pdf("Nthy_200iRefIndex_PrInCE_FDR005_interactions_truepositive_withcutoff05.pdf")
...
```{r Output}
rio::export(interactions_alltrue, "Nthy_200iRefIndex_FDR005_interactions_alltrue.tsv")
rio::export(interactions_cutoff, "Nthy_200iRefIndex_FDR005_interactions_alltrue_over05.tsv")
save.image("Nthy_200iRefIndex_FDR005_PrInCE.RData")
```