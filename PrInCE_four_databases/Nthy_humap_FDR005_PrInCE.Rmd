---
title: "Nthy_humap_PrInCE_FDR005"
author: "MenggeLYU"
date: "2024-09-20"
...
setwd("/PrInCE/FDR005/humap/Nthy")
library(ggplot2)
library(PrInCE)
library(CCprofiler)
library(dplyr)
...
save.image("Nthy_humap_FDR005_PrInCE.RData")
rio::export(interactions, "Nthy_humap_FDR005_interactions.tsv")
```


```{r Interactions plot}
pdf("Nthy_humap_PrInCE_FDR005_interactions_truepositive_withcutoff05.pdf")
...
```{r Output}
rio::export(interactions_alltrue, "Nthy_humap_FDR005_interactions_alltrue.tsv")
rio::export(interactions_cutoff, "Nthy_humap_FDR005_interactions_alltrue_over05.tsv")
save.image("Nthy_humap_FDR005_PrInCE.RData")
```